...
/**
 * Simple example to show how it is possible to create a new .torrentMetaInfo file to
...
class ExampleCreateTorrent{
    public static void main(String[] args){
        ...
        TorrentBuilder tp = new TorrentBuilder();
        ...
        try{
            ...
            System.err.println(
                    "Problem when adding files to torrentMetaInfo. Check your data");
            System.exit(0);
        }
        i++;
        String creator = "";
        ...
        try{
            ...
            System.err.println("Error when writing to the torrentMetaInfo file...");
            System.exit(1);
        }
    }
}
