...
public class BDecoder {
    ...
    public Map
        ...
        if (res == null) {
            ...
            throw (new IOException("BCoder: zero length file"));

        } else if (!(res instanceof Map)) {

            throw (new IOException("BCoder: top level isn't a Map"));
        }
    ...
    private Object
        ...
        case 'd':
            ...
            try {
                ...
                while ((tempByteArray = (byte[]) decodeInputStream(bais,
                    ...
                    //add the getParamName to the map
                ...
                if (nesting > 0 && tempByte == -1) {
                    ...
                    throw (new IOException(
                            "BCoder: invalid input data, 'e' missing from end of dictionary"));
                }
            } catch (Throwable e) {
        ...
        case 'l':
            ...
            try {
                ...
                if (nesting > 0 && tempByte == -1) {
                    ...
                    throw (new IOException(
                            "BCoder: invalid input data, 'e' missing from end of list"));
                }
            } catch (Throwable e) {
        ...
        default: {
            ...
            throw (new IOException(
                    "BCoder: unknown command '" + tempByte + ", remainder = " +
                    new String(rem_data)));
        }
        }
    }
    ...
    private byte[] getByteArrayFromStream(InputStream bais) throws IOException {
        ...
        // note that torrentMetaInfo hashes can be big (consider a 55GB file with 2MB pieces
        ...
        if (count != tempArray.length) {
            throw (new IOException(
                    "BCoder::getByteArrayFromStream: truncated"));
        }
