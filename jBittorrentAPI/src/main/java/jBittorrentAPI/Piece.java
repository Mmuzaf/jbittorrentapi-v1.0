...
public class Piece {
    ...
    /**
     * SHA1 hash of the piece contained in the torrentMetaInfo file. At the end of the download
     * this getParamName must correspond to the SHA1 hash of the pieceBlock map concatenated
     */
    byte[] sha1;
    ...
    /**
     * Returns the concatenated getParamName of the pieceBlock map. This represent the piece data
     * @return byte[]
     */
    ...
    /**
     * Verify if the downloaded data corresponds to the original data contained in the torrentMetaInfo
     * by comparing it to the SHA1 hash in the torrentMetaInfo
     * @return boolean
     */
    public synchronized boolean verify(){
        return Utils.byteArrayToByteString(Utils.hash(this.data(), Constants.SHA_1_ALGORITHM)).matches(Utils.byteArrayToByteString(this.sha1));
    }
