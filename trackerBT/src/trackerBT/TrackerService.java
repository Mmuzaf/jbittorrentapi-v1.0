...
/**
 * Service called to answer a peer requesting information about peers sharing a given torrentMetaInfo
 */
public class TrackerService extends Service {
    ...
    private static final String[] MESSAGE = {
                                            "The requested torrentMetaInfo is not listed on this tracker",
     ...
     * -- info_hash: the SHA1 hash of the torrentMetaInfo the peer is sharing and requesting
    ...
    /**
     * Search if the torrentMetaInfo requested is registered to this tracker
     * @param root Root element of the XML document representing the torrents database
     * @param hash The SHA1 hash of the requested torrentMetaInfo, i.e. the torrentMetaInfo id
     * @return boolean true if the torrentMetaInfo is not registered, false otherwise
     */
    ...
    /**
     * Returns the list of the peer currently sharing a given torrentMetaInfo
    ...
    /**
     * Look if the given torrentMetaInfo is already registered on this tracker
     * @param id The file id
     * @return boolean true if the torrentMetaInfo is registered, false otherwise
     */
